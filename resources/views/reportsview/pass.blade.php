...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="{{route('reportsview.newindex')}}" method="post">
    @if (!empty($mess))
        <div class='alert  alert-danger' style='background-color:#BD4B4B; text-align: center;'><p>{{$mess}}</p></div>
    @endif
    @csrf
