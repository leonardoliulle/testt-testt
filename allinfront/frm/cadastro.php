	...
	<body class="no-trans">
		...
		<footer id="footer">
			...
			<div class="footer section">
				<div class="container">
					<h1 class="title text-center" id="contact">Cadastro - Excel para Advogados</h1>
					<div class="space"></div>
					<div class="row">
						<div class="col-sm-6">
...
telefone: 1234*/
				...
				$message = "Nome: " . $nome . PHP_EOL;
				$message .= "cpf: " . $cpf . PHP_EOL;
				$message .= "oab: " . $oab . PHP_EOL;
				$message .= "email: " . $email . PHP_EOL;
				$message .= "telefone: " . $telefone . PHP_EOL;
